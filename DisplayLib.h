...
VIN
CLK (SPI CLOCK INPUT)
MOSI (Send data to TFT and SD)
CS (TFT SPI Chip select)
D/C (TFT data/command pin)


LRCLK/WCLK 23
MCLK 11 (STILL USED SO LEAVE EMPTY)
BCLK 9
TX 22
...
SDA (i2c data pin)
SCL (isc clock pin)
IRQ (touch interrupt pin)

Lite (PWM
RST (RESET TFT Not Needed)
MISO (SDCARD Read)
